...
function SearchPageClient() {
  ...
  return (
    <PageLayout activePath='/search'>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-20 md:bottom-6 right-6 z-[500] w-12 h-12 bg-orange-500/90 hover:bg-orange-500 text-white rounded-full shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out flex items-center justify-center group ${
          showBackToTop
